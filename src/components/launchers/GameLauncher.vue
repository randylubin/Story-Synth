<template>
  <div class="game-launcher">
    ...
    <div class="container" style="margin-top: 76px">
      <b-alert show class="" variant="info" v-if="customOptions.demoInfo">This demo is powered by a <a
          :href="customOptions.demoInfo" target="_blank">Google Sheet</a>, click to view the spreadsheet behind this
        game. Make a copy and start editing to design your own game!</b-alert>
