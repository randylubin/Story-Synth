    ...
    <div class="row mb-4" v-if="$route.params.roomID">
      <div class="col-sm">
        ...
        <transition name="bounce">
          <p v-if="roomInfo" :key="Object.keys(roomInfo).length">current viewers {{ Object.keys(roomInfo).length }} 👀</p>
        </transition>
      </div>
    </div>
