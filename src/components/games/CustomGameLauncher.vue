    ...
    return {
        ...
        gameMetaData: {
          'Around-The-Realm': {
            ...
            'gameBlurb': 'Tell the story of two close companions racing their way around a fantasy world. Nella and Bly wagered that they could travel completely around the realm and return before the summer solstice.',
            'ogImage': 'https://diegeticgames.com/uploads/around-the-realm-square-unfurl.png', 
          },
          'Post-Work-Paradise': {
            'gameTitle': 'Post-Work Paradise',
            'gameBlurb': "This game explores what life might be like in a world where work is obsolete. How do people choose to live and spend their time?",
