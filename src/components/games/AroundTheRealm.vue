  ...
  methods: {
    ...
    fetchAndCleanSheetData(){
        ...
        let gRows = [
            ...
            ["0","The Setting","This story takes place on the The Whirl - an archipelago of islands in the shape of a circle. The islands are contain myriad kingdoms and city states; the sea at the center of The Whirl contains a massive and unending maelstrom, the result of a spell gone wrong in centuries past.","-","-","-","-","-","-"  ],
