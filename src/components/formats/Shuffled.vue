  ...
  <div class="shuffled game-room" v-if="roomInfo">
    <app-menuBar :roomInfo="roomInfo" :tempExtensionData="tempExtensionData" :customOptions="customOptions"
      ...
      <div class="row menu-row" v-if="!roomInfo.xCardIsActive">
        <button class="btn btn-outline-dark btn-lg w-100 control-button-safety-card"
      ...
      <div class="row menu-row">
        <button data-bs-dismiss="modal" v-on:click="nextDeck();" class="btn btn-outline-dark control-button-next-deck btn-lg w-100" v-if="
      ...
      <div v-if="customOptions.treatLastCardAsLastDeck"
        ...
        <button data-bs-dismiss="modal" variant="outline-dark" class="btn btn-outline-dark control-button-last-deck btn-lg w-100" v-on:click="
  lastCard();
        " :disabled="
          roomInfo.xCardIsActive ||
      ...
      ">
        ...
        <div class="row menu-row" v-if="!customOptions.hideLastCardOptions">
          <button data-bs-dismiss="modal" class="btn w-100 btn-secondary" v-on:click="
  lastCard();
          " :disabled="
            roomInfo.xCardIsActive ||
            roomInfo.currentCardIndex == gSheet.length - 1 ||
              ...
              <div class="card d-flex">
                <div class="card-body">
                  ...
                  <div v-for="chapter in chapterNavLabels" :key="chapter.label">
                    <b-button class="w-100 btn-default my-2 chapter-nav-button"
