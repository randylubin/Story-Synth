    ...
    <div class="row">
      <div class="col">
        <div class="card card-body shadow">
          ...
          <p>The funds for this program are provided by <a href="https://www.grantfortheweb.org/">Grant for the Web</a>,
            a non-profit seeking to boost open, fair, and inclusive standards and innovation in web monetization;
            enabling new ways for content creators to earn incomes online.</p>

          <p>The <a href="https://webmonetization.org/">Web Monetization standard</a> allows sites to know if a site
            visitor is sending a stream of micropayments and, if so, the site can then enable content or functionality
            for that user. An early example of this is <a href="https://coil.com/">Coil</a>, a browser extension where a
            user can subscribe for $5.00 per month and that money is shared among the sites that the user visits, based
            on time spent.</p>

          <p>In addition to the $300 grant award, recipients will also receive micropayments from players playing the
            game. They might start as just pennies here and there, but as more people play they will begin to add up.
          </p>

          <p>Story Synth currently has a basic implementation of web monetization via the monetization <a
              href="https://docs.storysynth.org/guide/options.html">custom option</a>. Over the next few months, we'll
            be adding new monetization related functionality to Story Synth, including the ability to restrict some or
            all of your game to groups of players using web monetization. Stay tuned for more details!</p>
        </div>
      </div>
    </div>
...
export default {
  ...
  metaInfo() {
    return {
      title: "Story Synth Grants",
      meta: [
        {
          property: "description",
          content: "Information about the Story Synth grant program, run by Big Bad Con and funded by Grant for the Web",
          vmid: "description",
        },
        {
          property: "og:title",
