  ...
  <div>
      ...
      <div class="container game-room">
        <div class="fab-buttons container">
          <button class="btn btn-outline-dark btn-fab btn-fab-left control-button-previous-card shadow"
            v-b-tooltip.hover title="Previous Card" :disabled="
              true
            ">
            <!-- Previous Card -->
        ...
        <div class="card shadow mb-4">
          <div class="card-body text-center">
            ...
            <p>Use this page to experiment with CSS for your game, then copy the style code into your Google Sheet.
              Check out the <a href="https://docs.storysynth.org/tutorials/styling.html#what-s-css">Story Synth CSS
    ...
    <div class="css-editor container-fluid p-4">
      <div class="row">
        <div class="col-sm">
          <h1>CSS Editor</h1>
          <p>Learn more in the <a href="https://docs.storysynth.org/guide/options.html#visual-style">Visual Style</a>
            section of the docs or via the Story Synth <a href="https://docs.storysynth.org/tutorials/styling.html">CSS
              Tutorial</a></p>
