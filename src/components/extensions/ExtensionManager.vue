  ...
  <div class="">
      <div class="row">
        <div class="col-sm">
          ...
          <app-embedWebsite class="extension" :hardcodedWebsiteURL="extensionData.hardcodedWebsiteURL" :selectedWebsiteURL="extensionData.selectedWebsiteURL" :embedWebsiteMessage="extensionData.embedWebsiteMessage" @process-extension-update="processExtensionUpdate($event)" v-if="extensionList.hardcodedWebsiteURL || extensionList.embedWebsiteMessage"></app-embedWebsite>
        </div>
      </div>
  </div>
</template>
