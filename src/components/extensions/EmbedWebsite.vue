  ...
  <div class="mb-4 embed-website" :class="{ 'iframe-expanded': expand }">
    <div class="card embed-website-message" v-if="!selectedWebsiteURL">
      <div class="card-body">
        ...
        <b-form-input v-model="newURL" class="form-control" placeholder="Paste a shared link here"
    ...
    <div class="card embed-website-by-url" v-if="selectedWebsiteURL">
      ...
      <div class="row">
        <div class="col-sm">
          <iframe width="100%" height="1500" :src="selectedWebsiteURL" allow="fullscreen" fetchpriority="low"
            title="Embedded Doc"></iframe>
        </div>
      </div>
    </div>
  </div>
